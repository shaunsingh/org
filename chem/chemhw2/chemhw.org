...
b. The sulfate ion has a charge of 2-
c. The barium ion has a charge of 2+
d. The nitrate ion has a charge of 1-
...
** TODO Calculate the number of grams per mole (gfm) for each of the following:
#+attr_latex: :options [(a)]
   a. $\ce{CuSO4}$
...
** TODO Show work Calculate the mass percent of $\ce{Cl}$ in each of the following compounds
#+attr_latex: :options [(a)]
...
** TODO Show work Calculate the mass percent of each element in $\ce{Ba(OH)2*8H2O}$, or barium hydroxide octahydrate
#+attr_latex: :options [(a)]
...
** TODO show work Determine the empirical formula of a compound that contains the following percentages of elements by mass: Mo = 43.95%, O = 7.33%, Cl = 48.72%
$\ce{Cl3MoO}$
