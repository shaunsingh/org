...
\label{sec:org609047e}
\subsection{Vocabulary}
\label{sec:orgcdb316f}
\begin{enumerate}
\item Word: bit
...
\label{sec:orgde64a0a}
\subsection{Vocabulary}
\label{sec:org71b1d15}
\begin{enumerate}
\item Word: pervasive
...
\label{sec:orge198f75}
\subsection{Vocabulary}
\label{sec:org9259352}
\begin{enumerate}
\item Word: metadata
...
\label{sec:org6d02570}
\subsection{Vocabulary}
\label{sec:org5e1de8b}
\begin{enumerate}
\item Word: bot
...
\item Web 2.0 sites—Facebook and Wikipedia, for example—exploit what economists call
\end{enumerate}
...
\section{Secret Bits}
\label{sec:orge79bed7}
\subsection{Vocabulary}
\label{sec:orgaf02d40}
\begin{enumerate}
\item Word: Cipher
...
\label{sec:org6b2ee86}
\subsection{Vocabulary}
\label{sec:org56d26ad}
\begin{enumerate}
\item Word: driftnet
